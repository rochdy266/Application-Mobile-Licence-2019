...
public class Favoriss extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener , favorisAdapter.onItemClickListener1 , RecyclerItemTouchHelperListener {
    ...
    public static ArrayList<Propriete> mListeFavoris ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListeFavoris = dataBaseManager.Afficher();

            mFavorisAdapter = new favorisAdapter(Favoriss.this, mListeFavoris);
            myRecyclerView.setAdapter(mFavorisAdapter);
            mFavorisAdapter.setOnItemClickListenner1(Favoriss.this);

        ItemTouchHelper.SimpleCallback itemTouchHelperCallBack = new RecyclerItemToucheHelper
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.favoris: {
                    ...
                    Intent intent=new Intent(this,Favoriss.class);
    ...
    public void onItemClick1(int position) {
        ...
        Propriete  click =  mListeFavoris.get(position);
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction, int position) {
        if (viewHolder instanceof favorisAdapter.MyViewHolder) {
            String titre = mListeFavoris.get(viewHolder.getAdapterPosition()).getTitre();
            Propriete deletedItem = mListeFavoris.get(viewHolder.getAdapterPosition());
            mFavorisAdapter.removeItem(position, this);
        }
    }
