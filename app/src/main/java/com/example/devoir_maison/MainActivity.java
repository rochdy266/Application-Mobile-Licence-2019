...
public class MainActivity extends AppCompatActivity implements  NavigationView.OnNavigationItemSelectedListener, ProprieteAdapter.onItemClickListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            return true;
            case R.id.depot: {
                Intent depot = new Intent(this, DeposerAnnonce.class);
                startActivity(depot);
            }
            return true;
            default:
